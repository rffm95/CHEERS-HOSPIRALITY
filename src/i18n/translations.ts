...
export const translations: Record<Language, Translation> = {
  pt: {
    ...
    consultingPage: {
      hero: {
        eyebrow: 'Consultoria Estratégica B2B',
        title: 'Transformação',
        titleAccent: 'Operacional.',
        description: 'Não vendemos apenas conselhos. Entregamos resultados. Ajudamos unidades de hospitalidade a atingir o seu potencial máximo através de engenharia de menu, standards de serviço e otimização de custos.',
      },
      transformation: {
        title: 'De um bar comum para uma',
        titleAccent: 'operação de elite.',
        features: [
          { title: 'Engenharia de Menu (ROI)', description: 'Analisamos a rentabilidade de cada ingrediente para criar cartas que vendem os produtos mais lucrativos.' },
          { title: 'Standards de Serviço', description: 'Formação de equipa focada em hospitalidade de luxo e técnicas de upselling para aumentar o ticket médio.' },
          { title: 'Controlo de F&B', description: 'Sistemas rigorosos de gestão de stock e redução de desperdício para proteger a sua margem.' },
        ],
      },
      partnership: {
        title: 'Parceria & Concessão',
        description: 'Tem um espaço de eventos ou hotel e procura uma gestão profissional de bar? Discutimos modelos de parceria ou concessão total, onde a Cheers assume a operação com os nossos standards de excelência.',
        cta: 'DISCUTIR PARCERIA',
      },
      painPoints: {
        title: 'Sente estes problemas no seu negócio?',
        items: [
          'Volume operacional elevado com margens de lucro reduzidas',
          'Inconsistência gritante nos padrões de serviço e hospitalidade',
          'Menus estáticos com baixa rotatividade de produtos premium',
          'Desperdício de stock impactando o Food & Beverage Cost',
          'Dificuldade na formação contínua e retenção de talentos',
        ],
      },
      cta: 'Leve o seu negócio para o próximo patamar de rentabilidade.',
    },
    digitalPage: {
      hero: {
        eyebrow: 'Hospitality Digital Solutions',
        title: 'Tecnologia que',
        titleAccent: 'Vende.',
        description: 'Unimos o digital ao físico para criar experiências de consumo memoráveis. Do menu QR que respira a sua marca à gestão de ecrãs que impulsiona o ticket médio.',
      },
      tvStrategy: {
        badge: 'Oportunidade Detectada',
        title: 'Os seus ecrãs estão a',
        titleAccent: 'perder dinheiro?',
        description: 'Ecrãs sintonizados em canais aleatórios são ruído. Transformamos as suas TVs em "Vendedores Silenciosos" que promovem cocktails, happy hours e eventos nos momentos de maior tráfego.',
        features: [
          { title: 'Promoção Dinâmica de ROI', description: 'Exiba os produtos com maior margem nos horários de pico.' },
          { title: 'Upsell Visual Imersivo', description: 'Imagens de alta qualidade que despertam o desejo imediato.' },
          { title: 'Gestão Centralizada', description: 'Atualize todos os ecrãs remotamente em segundos.' },
        ],
        preview: {
          eyebrow: 'Live Digital Signage',
          title: 'HAPPY HOUR',
          subtitle: 'Cocktails Selecionados 2x1 • 17:00 - 19:00',
        },
      },
      aiSocial: {
        eyebrow: 'Social Media Management',
        popularTag: 'Recomendado',
        cta: 'OBTER ESTRATÉGIA SOCIAL',
      },
      signage: {
      ...
      services: {
        items: [
          { title: 'Menus QR de Luxo', text: 'Substitua o papel por menus digitais elegantes, multilingues e otimizados para vendas.' },
          { title: 'Digital Signage Pro', text: 'Instalação e gestão de ecrãs para lobbies, bares e áreas comuns com foco comercial.' },
          { title: 'AI Social Engine', text: 'Gestão de redes sociais que une IA e expertise real em hospitalidade para conteúdo autêntico.' },
          { title: 'Revenue Optimization', text: 'Estratégias digitais desenhadas para aumentar o consumo de produtos premium.' },
          { title: 'Multi-idioma Nativo', text: 'Traduções que respeitam a terminologia técnica do setor para turistas exigentes.' },
          { title: 'Suporte & Evolução', text: 'Manutenção contínua e atualização de conteúdos para que nunca fique desatualizado.' },
        ],
      },
      cta: {
        title: 'Digitalize a sua operação hoje.',
        button: 'PEDIR DIAGNÓSTICO DIGITAL',
      },
    },
    eventsPage: {
      hero: {
        eyebrow: 'Premium Bar Services',
        title: 'Eventos que',
        titleAccent: 'Elevam.',
        description: 'Levamos a sofisticação de um bar de luxo para o seu evento. Seja um casamento exclusivo, um evento corporativo ou uma festa privada, a nossa equipa garante uma execução impecável e cocktails de autor.',
        note: 'Disponibilidade limitada para épocas festivas',
      },
      categories: {
        weddings: 'Casamentos de Luxo',
        corporate: 'Eventos Corporativos',
        private: 'Festas Privadas',
        baptisms: 'Celebrações Familiares',
      },
      quote: {
        title: 'Pronto para o seu',
        titleAccent: 'Próximo Evento?',
        description: 'Peça uma proposta personalizada e descubra como podemos transformar o seu evento numa experiência memorável.',
        cta: 'PEDIR PROPOSTA DE EVENTO',
      },
    },
    portfolioPage: {
      hero: {
    ...
    homePage: {
      hero: {
        ...
        description: 'Especialistas em serviços de bar premium, consultoria estratégica e soluções digitais de alto rendimento. Unimos visão operacional e execução impecável para transformar o seu negócio.',
      },
      whyCheers: {
        title: 'Porquê a Cheers?',
        subtitle: 'Não somos apenas uma agência. Somos parceiros operacionais com anos de experiência real no terreno.',
        items: [
          { title: 'Visão 360º', description: 'Compreendemos o ecossistema hospitality: do cocktail no copo à margem no balanço final.' },
          { title: 'Execução de Elite', description: 'Equipas formadas sob os mais altos standards de serviço e hospitalidade de luxo.' },
          { title: 'Inovação Digital', description: 'Tecnologia proprietária desenhada para vender mais e profissionalizar a comunicação.' },
          { title: 'Foco em ROI', description: 'Cada ação, cada menu e cada ecrã é desenhado com a rentabilidade em mente.' },
        ],
      },
      methodology: {
        title: 'O Nosso Método',
        steps: [
          { number: '01', title: 'Diagnóstico', description: 'Analisamos a sua operação, gaps e oportunidades de crescimento real.' },
          { number: '02', title: 'Estratégia', description: 'Desenhamos uma solução customizada: seja um evento, uma carta ou um sistema digital.' },
          { number: '03', title: 'Execução', description: 'Implementamos com precisão cirúrgica, garantindo consistência e qualidade.' },
          { number: '04', title: 'Otimização', description: 'Monitorizamos resultados e ajustamos para maximizar a performance contínua.' },
        ],
      },
      ctaSection: {
        title: 'Pronto para elevar os seus',
        titleAccent: 'Standards?',
        description: 'Seja para um evento exclusivo ou para profissionalizar a sua unidade, a nossa equipa está pronta para intervir.',
