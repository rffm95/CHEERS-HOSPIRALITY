    ...
    <div className="w-full bg-[#050505]">
      ...
      <section className="relative h-screen w-full flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-full h-full opacity-30 grayscale mix-blend-screen pointer-events-none">
             <img
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-10 pt-20 grid grid-cols-12 w-full">
          ...
          >
            ...
            <h1 className="text-6xl md:text-[110px] font-black uppercase tracking-tighter leading-[0.85] text-white mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                to="/contact"
                className="group relative px-12 py-6 bg-white text-black font-black uppercase tracking-[0.2em] text-[10px] hover:bg-[#c5a059] transition-all flex items-center justify-center gap-3"
              >
                {t.hero.ctaQuote}
              ...
              <Link
                to="/portfolio"
                className="px-12 py-6 border border-white/20 text-white font-black uppercase tracking-[0.2em] text-[10px] hover:bg-white hover:text-black transition-all text-center"
              >
                {t.nav.portfolio}
              </Link>
            </div>
        ...
        <motion.div 
          ...
          className="absolute bottom-10 left-10 flex items-center gap-4 text-white/20"
        >
      ...
      <section className="bg-[#050505] border-y border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto px-0 grid grid-cols-1 lg:grid-cols-3">
          {['events', 'consulting', 'digital'].map((key, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`group relative p-16 border-white/5 hover:bg-white/[0.02] transition-all duration-700 ${
                i !== 2 ? 'lg:border-r' : ''
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-4xl font-black text-white mb-6 tracking-tight uppercase group-hover:text-[#c5a059] transition-colors leading-tight">
      ...
      <section className="py-32 px-10 bg-[#050505] relative">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 text-center">
            <span className="text-[#c5a059] text-[10px] uppercase tracking-[0.4em] font-black mb-4 block">Trust & Expertise</span>
            <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase mb-6">{t.homePage.whyCheers.title}</h2>
            <p className="text-white/40 max-w-2xl mx-auto text-lg leading-relaxed">{t.homePage.whyCheers.subtitle}</p>
          </div>
            ...
            {t.homePage.whyCheers.items.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-zinc-900/30 p-10 rounded-3xl border border-white/5 group hover:bg-zinc-900/50 transition-all duration-500"
                >
                  ...
                  <h4 className="text-white font-black uppercase text-sm tracking-widest mb-4">{item.title}</h4>
      ...
      <section className="py-32 bg-zinc-900/20">
        <div className="max-w-7xl mx-auto px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase mb-12">
              ...
              <div className="space-y-2">
                {t.homePage.methodology.steps.map((step, i) => (
                  <motion.div
                    ...
                    transition={{ delay: i * 0.2 }}
                    viewport={{ once: true }}
                    className="group flex gap-8 p-8 rounded-3xl hover:bg-white/[0.03] transition-all cursor-default"
                  >
                    <span className="text-4xl font-black text-white/5 group-hover:text-[#c5a059] transition-colors">{step.number}</span>
                    <div>
                      <h4 className="text-white font-black uppercase text-sm tracking-widest mb-2">{step.title}</h4>
                      <p className="text-white/40 text-sm leading-relaxed max-w-md">{step.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative aspect-square bg-zinc-900 rounded-[60px] border border-white/5 overflow-hidden flex items-center justify-center p-12">
                <div className="text-center">
                  <div className="w-32 h-32 bg-[#c5a059] rounded-full flex items-center justify-center mx-auto mb-10 shadow-[0_0_50px_rgba(197,160,89,0.3)]">
                    <Zap className="w-16 h-16 text-black fill-black" />
                  </div>
                  <h3 className="text-3xl font-black text-white uppercase tracking-tighter mb-4">Focus on Success</h3>
                  <p className="text-white/40 text-sm tracking-[0.2em] uppercase font-black">Guaranteed Transformation</p>
                </div>
                {/* Decorative Elements */}
                <div className="absolute top-10 right-10 w-40 h-px bg-gradient-to-l from-[#c5a059]/30 to-transparent" />
                <div className="absolute bottom-10 left-10 w-40 h-px bg-gradient-to-r from-[#c5a059]/30 to-transparent" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-40 bg-[#050505] overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-zinc-900/50 rounded-[60px] p-16 md:p-24 relative border border-white/5 overflow-hidden group"
          >
            ...
            <div className="relative z-10 shrink-0">
              <Link
                to="/contact"
                className="group inline-flex items-center gap-4 px-12 py-7 bg-[#c5a059] text-black font-black uppercase tracking-[0.2em] text-xs hover:scale-105 transition-all shadow-2xl"
              >
