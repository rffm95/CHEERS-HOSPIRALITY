          ...
          <div className="col-span-1 lg:col-span-1">
            <Link to="/" className="flex items-center gap-4 mb-8 group">
              <img 
                ...
                className="w-12 h-12 object-contain rounded-sm transition-transform duration-500 group-hover:scale-110"
                referrerPolicy="no-referrer"
              />
              <span className="text-2xl font-black tracking-tighter text-[#111111] uppercase block">
                Cheers <span className="text-stroke-accent italic text-[#c5a059]">Experiences</span><span className="text-[#c5a059]">.</span>
              </span>
            </Link>
